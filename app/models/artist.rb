class Artist < ApplicationRecord
    ...
    validates :artist_artwork, file_content_type: { allow: [:gif, :png, :jpg, :jpeg], message: 'must be file type gif, png, jpg, or jpeg' }, file_size: { less_than: 10.megabytes , message: 'must be less than 10MB in size' } 
